...
// basically prototype object is attached to every object, method, array, func
...
function Profile(n, a, o, h) {
  (this.name = n), (this.age = a), (this.occupation = o), (this.address = h);
  this.intro = () => {
    console.log(
      this.name + ' ' + this.age + ' ' + this.occupation + ' ' + this.address
    );
  };
}
...
Profile.prototype.introduction = function () {
  console.log(
    'I am function attached to prototype,',
    this.name + ' **** ' + this.age
  );
