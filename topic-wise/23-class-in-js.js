...
// Ram.sayHello() // ==> throws an error

person.sayHello() // works properly
...
class Manager extends Employee{  // here manager(Child) class is inheriting class Employee props and methods
    constructor(n, d){
...
class student {
    ...
    getName(){
        console.log(this.name + ' ' + this.class_year + ' ' + this.discipline + ' '  + this.hostel)
    }

    girlFriend(){    // now this function has become pvt, can be accessed inside this class only
    ...
    details(){
        ...
        console.log('Rohit mad in Love, Jennie gets sexual favours from other boys too')
        this.#secret()
    }
}
